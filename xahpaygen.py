...
def get_currency(wallet_address):
    return requests.get(f"https://api.xahscan.com/api/v1/account/{wallet_address}/obligations?origin=https://xahau.services").json()[0]["currency"]
